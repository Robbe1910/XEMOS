...
@Component({
  selector: 'app-terminal-ucr3-d',
  templateUrl: './terminal-ucr3-d.component.html',
  styleUrls: ['./terminal-ucr3-d.component.scss']
})
export class TerminalUCR3DComponent {
  constructor() {
