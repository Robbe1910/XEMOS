...
@Component({
  selector: 'app-terminal3D',
  templateUrl: './terminal3D.component.html',
  styleUrls: ['./terminal3D.component.scss']
})
export class Terminal3DComponent implements OnInit, OnDestroy
{
  constructor() {
